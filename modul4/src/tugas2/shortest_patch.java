...
/* inisialisasi array graph yang merepresentasikan graf dengan bobot pada setiap sisi (edge). Selanjutnya, dibuat objek dari kelas shortest_patch dengan menggunakan
 *  konstruktor default (new shortest_patch()). Kemudian, dipanggil method dijkstraAlgorithm dengan parameter graph dan 0. Method dijkstraAlgorithm akan menjalankan 
 *  algoritma Dijkstra untuk mencari lintasan terpendek dari simpul dengan indeks 0 ke seluruh simpul lainnya pada graf yang diwakili oleh graph. Hasil lintasan
